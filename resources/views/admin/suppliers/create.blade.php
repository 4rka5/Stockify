...
@section('breadcrumb', 'Home / Supplier / Tambah')
...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-md p-6">
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-600">Isi form di bawah untuk menambah supplier baru</p>
        </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="text-sm text-blue-800">
                        ...
                        <ul class="list-disc list-inside space-y-1">
                            ...
                            <li>Email, telepon, dan alamat bersifat opsional</li>
                            <li>Pastikan nama supplier unik</li>
                        </ul>
                    </div>
                </div>
            </div>
